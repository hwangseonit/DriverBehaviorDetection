...
#     try:
#         return {
#             'DenseNet121': load_model('model/best_model_densenet.h5'),
#             'MobileNetV2': load_model('model/best_model_mobilenetv2.h5'),
#             'ResNet50': load_model('model/best_model_resnet.h5')
#         }
